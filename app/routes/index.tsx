export default function Index() {
  return (
    <section className="grid place-items-center min-h-screen bg-white text-black dark:bg-black dark:text-gray-50">
      <div className="flex items-center">
        ...
        >
          ...
          <g filter="url(#filter0_dd_126_53)" fill="#E8F2FF">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
        ...
        <span className="inline-block mx-4 text-5xl">+</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 174 68" className="w-32 h-32">
          <defs>
